...
export async function chat(messages: ChatMessage[], customApiKey?: string) {
...
export async function summarize(oldHistory: ChatMessage[], currentSummary: string): Promise<string> {
